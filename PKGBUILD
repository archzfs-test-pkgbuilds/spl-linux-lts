...
pkgrel=1
makedepends=("linux-lts-headers=4.14.44-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-lts=4.14.44-1")
...
package_spl-linux-lts-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.14.44-1-lts/Module.symvers
}
